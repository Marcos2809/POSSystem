				...
				<div class="nav-collapse">
					<?php $this->widget('zii.widgets.CMenu',array(
						...
						'items'=>array(
							...
							array('label'=>'Acerca de POSSystem', 'url'=>array('/site/page', 'view'=>'about')),
							array('label'=>'Conctacto', 'url'=>array('/site/contact')),
	  ...
	  <div class="container">
		<div class="row">
			<div id="footer-copyright" class="col-md-6">
				Acerca de nosotros | Contactanos | Terminios & Condiciones
			</div> <!-- /span6 -->
			<div id="footer-terms" class="col-md-6">
				<a href="http://Corplinesoft.com.mx" target="_blank">© 2016 CORPLINESOFT.</a>.
			</div> <!-- /.span6 -->
		 </div> <!-- /row -->
	  </div> <!-- /container -->
	</div>
